...
// (_next, _vercel), and any path containing a file extension (e.g.
// /favicon.ico). This exclusion happens BEFORE middleware() is invoked, so
// it cannot be verified by calling middleware() directly in a test; see
// tests/middleware-matcher.test.ts, which checks this pattern in isolation.
